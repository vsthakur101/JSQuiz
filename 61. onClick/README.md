...
6. `document.body.click()` triggers click event
...
### Event Queue
* Click event listener callback executes, logging `2`
...
2. Microtasks (Promises) execute before event queue
3. Event queue callbacks execute before macrotasks
4. Event order:
   * Synchronous code
   * Microtasks
   * Event queue
